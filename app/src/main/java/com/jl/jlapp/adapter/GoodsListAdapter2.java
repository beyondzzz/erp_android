...
public class GoodsListAdapter2 extends RecyclerView.Adapter<GoodsListAdapter2.ViewHolder> implements View.OnClickListener {
...
//    }
    ...
    private  List<AdvertisementByIdModel.ResultDataBean.GoodsBean> data;
    ...
    //构造函数
    public GoodsListAdapter2(Context context, List<AdvertisementByIdModel.ResultDataBean.GoodsBean> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = inflater.inflate(R.layout.goods_list_item2, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        AdvertisementByIdModel.ResultDataBean.GoodsBean item = data.get(position);
...
//        holder.goods_img.setImageResource(item.getGoodsSpecificationDetails().get(0).getGoodsDisplayPictures().get(0));
        ...
        if(item.getGoodsSpecificationDetails().get(0).getGoodsDisplayPictures().size()>0){
            String picUrl = item.getGoodsSpecificationDetails().get(0).getGoodsDisplayPictures().get(0).getPicUrl();
                ...
                Glide
                        ...
                        .asBitmap().apply(new RequestOptions().placeholder(R.drawable.img_noimg_s).error(R.drawable.img_noimg_s))
    ...
    public interface OnItemClickListener{
        void onItemClick(int position, AdvertisementByIdModel.ResultDataBean.GoodsBean data);
    }
