...
public class GoodsListAdapter4 extends BaseQuickAdapter<AdvertisementByIdModel.ResultDataBean.GoodsBean, BaseViewHolder> {

    public GoodsListAdapter4(@LayoutRes int layoutResId, @Nullable List<AdvertisementByIdModel.ResultDataBean.GoodsBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, AdvertisementByIdModel.ResultDataBean.GoodsBean item) {
