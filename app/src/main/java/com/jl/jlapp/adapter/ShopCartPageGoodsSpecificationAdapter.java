...
public class ShopCartPageGoodsSpecificationAdapter extends BaseQuickAdapter<ShoppingCartModel.ResultDataBean.GoodsDetailsBean.GoodsSpecificationDetailsBean,BaseViewHolder> {
    ...
    public ShopCartPageGoodsSpecificationAdapter(int layoutResId, @Nullable List<ShoppingCartModel.ResultDataBean.GoodsDetailsBean.GoodsSpecificationDetailsBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ShoppingCartModel.ResultDataBean.GoodsDetailsBean.GoodsSpecificationDetailsBean item) {
