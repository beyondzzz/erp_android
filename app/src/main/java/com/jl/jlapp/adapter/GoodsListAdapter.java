...
public class GoodsListAdapter extends BaseQuickAdapter<GoodsListModel.ResultDataBean, BaseViewHolder> {

    public GoodsListAdapter(@LayoutRes int layoutResId, @Nullable List<GoodsListModel.ResultDataBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, GoodsListModel.ResultDataBean item) {
