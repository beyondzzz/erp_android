...
public class Config {
     ...
     * QQ登录的APPID
     */
    public static final String QQ_LOGIN_APP_ID = "1106681667";

    /**
     * app_id是从微信官网申请到的合法APPid
     */
    public static final String APP_ID_WX = "wx037454184aee70e9";

    /**
     * 微信AppSecret值
     */
    public static final String APP_SECRET_WX = "cbdab39fdc019dac230045a25e745ae1";
